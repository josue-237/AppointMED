...
app.config[
    "MONGO_URI"
] = "mongodb+srv://SDS:" + os.environ.get("MONGO_PW")+ "@cluster0.zc52h.mongodb.net/myFirstDatabase?retryWrites=true&w=majority"

time_slots = ["08:00am", "08:30am", "09:00am", "09:30am", "10:00am", "10:30am", "11:00am", "11:30am", "12:00pm", "12:30pm",
...
def schedule():
    ...
    if request.form == "GET":
        ...
        return render_template("appointment.html",day='',time_slots=time_slots,doctor_image="https://www.pinnaclecare.com/wp-content/uploads/2017/12/bigstock-African-young-doctor-portrait-28825394.jpg",doctor_name="Richard Silverstein",doctor_specialty="Dermatologist", doctor_address="14 Calle Peral N Ste La Mayaguez PR, 00680, Estados Unidos", doctor_phone="559-206-4429",medical_plans=medical_plans)
    else:
        day=request.form.get('day')
        return render_template("appointment.html",day=day,time_slots=time_slots,doctor_image="https://www.pinnaclecare.com/wp-content/uploads/2017/12/bigstock-African-young-doctor-portrait-28825394.jpg",doctor_name="Richard Silverstein",doctor_specialty="Dermatologist", doctor_address="14 Calle Peral N Ste La Mayaguez PR, 00680, Estados Unidos", doctor_phone="559-206-4429",medical_plans=medical_plans)
